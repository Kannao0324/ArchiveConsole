...
public class UIBuilderLibrary
{
     ...
     * @param other The component which the text field will be located in association to.
     *
     * @retlayout.putConstraint(SpringLayout.WEST, myTextField,0,SpringLayout.WEST,other);
     *         layout.putConstraint(SpringLayout.NORTH, myTextField,vPad,SpringLayout.SOUTH,other);
     *         return  myTextField;urn A completed and setup TJextField ready to be added to a Frame
     */
     ...
     * @return
     */
    public static JButton BuildJButtonWithSouthEastAnchor(int width, int height, String text, int hPad, int vPad,
                                                          ActionListener listener, SpringLayout layout, Component other)
    {
        // Create a new button object with the specified text displayed on it.
        JButton myButton = new JButton(text);
        ...
        myButton.addActionListener(listener);
        // Constrain the vertical and horizontal positions of the button
        layout.putConstraint(SpringLayout.EAST, myButton,hPad,SpringLayout.EAST,other);
        layout.putConstraint(SpringLayout.SOUTH, myButton,vPad,SpringLayout.SOUTH,other);
        return  myButton;
    }
